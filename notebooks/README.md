...
The project uses ML models, including **tree-based gradient boosting (XGBoost)**, **Naive Bayes**, and **Random Forest** with an aim to detect high-risk students that is likely to dropout in the next 5 weeks, therefore building reliable warning systems.
